function CL = mixFrG180CL(theta,data)
% Description: The negative log-likelihood of MixFrG180 copula model.
%
...
alpha2 = theta(3);   % rotated Gumbel copula parameter (180-degrees)
