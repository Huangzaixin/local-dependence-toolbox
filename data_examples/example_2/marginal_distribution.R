...
p <- ggplot(cases_deaths_data, aes(x = x, y = y)) + 
        ...
        labs(title = "", x = "cumulative number of cases", y = "cumulative number of deaths") +
...
hist_cases <- hist(cases_data, breaks = 2000, probability = TRUE, 
                   ...
                   xlab = "cumulative number of cases", ylab = "density", 
...
hist_deaths <- hist(deaths_data, breaks = 3000, probability = TRUE, 
                   ...
                   xlab = "cumulative number of deaths", ylab = "density", 
                   col = "lightblue", border = "black", main = "")
x <- seq(0, display_upper_bound, by = 1)
