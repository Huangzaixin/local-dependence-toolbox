...
% NOTE: Although the AIC value of MixGrG180 copula is smaller than that of the Gumbel copula, the weight parameter of Clayton copula is very small. 
%       Therefore, we select Gumbel copula as the best model.
AIC = -2*(-LL) + 2*3;
AIC   %  -6850.46
pars_grg
...
AIC = -2*(-LL) + 2*3;
% NOTE: Although the AIC value of MixFG copula is smaller than that of the Gumbel copula, the weight parameter of Frank copula is very small. 
%       Therefore, we select Gumbel copula as the best model.
AIC   %  -6850.99
pars_fg
