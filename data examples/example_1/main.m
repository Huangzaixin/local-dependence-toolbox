%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%   Example 1: estimate global and local Kendall's tau between CSF FAM171A2 and total α-syn   %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% basic settings
break;
...
%% read data
u = csvread('data examples/example_1/data/inv_u_FAM171A2.csv',1,0);    % FAM171A2
v = csvread('data examples/example_1/data/v_alpha_syn.csv',1,0);      % α-syn
UV = [u v];

%% parameter(s) of the single or mixture copula model
copula_type = 'mixfrc180';
weight1 = pars_frc(1);             % the weight of the first copula function in the mixture copula model
weight2 = 0;                       % the weight of the second copula function in the mixture copula model
copulaparameter1 = pars_frc(2);    % for mixture copula model, parameter of the first copula function; for sjc copula, the upper tail dependence coefficient   
copulaparameter2 = pars_frc(3);    % for mixture copula model, parameter of the second copula function; for sjc copula, the lower tail dependence coefficient 
...
% the following four quantiles are calculated by the inverses of the distributions of FAM171A2 and total α-syn
ul_quantile = 0;        % lower bound of u
uu_quantile = 1;        % upper bound of u
vl_quantile = 0;        % lower bound of v
vu_quantile = 1;        % upper bound of v

%% initiate values for mixfrc180 copula
...
% NOTE: if mean_b_nonparametric produces NaN, you can try other values for par0 to see if that resolves the issue.
